    ...
    public string ObterPreco(string descricaoProduto, int idProduto)
    {
        ...
        try
        {
            ...
            if (firstProductPriceNode != null)
            {
                ...
                RegistrarLog("0088663", "andressalima", DateTime.Now, "WebScraping - Mercado Livre", "Sucesso", idProduto);
            ...
            else
            {
                ...
                // Registra o log com o ID do produto
                RegistrarLog("0088663", "andressalima", DateTime.Now, "WebScraping - Mercado Livre", "Preço não encontrado", idProduto);
        ...
        catch (Exception ex)
        {
            ...
            // Registra o log com o ID do produto
            RegistrarLog("0088663", "andressalima", DateTime.Now, "Web Scraping - Mercado Livre", $"Erro: {ex.Message}", idProduto);
