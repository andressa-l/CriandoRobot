...
public class MagazineLuizaScraper
{
    public string ObterPreco(string descricaoProduto, int idProduto)
    {
        try
        {
            ...
            using (IWebDriver driver = new ChromeDriver())
            {
                ...
                if (priceElement != null)
                {
                    ...
                    RegistrarLog("0088663", "andressalima", DateTime.Now, "WebScraping - Magazine Luiza", "Sucesso", idProduto);
                ...
                else
                {
                    ...
                    // Registra o log com o ID do produto
                    RegistrarLog("0088663", "andressalima", DateTime.Now, "WebScraping - Magazine Luiza", "Preço não encontrado", idProduto);
        ...
        catch (Exception ex)
        {
            ...
            // Registra o log com o ID do produto
            RegistrarLog("0088663", "andressalima", DateTime.Now, "Web Scraping - Magazine Luiza", $"Erro: {ex.Message}", idProduto);
